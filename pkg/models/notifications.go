...
var NotificationTableColumns = struct {
	...
	ID:          "notifications.id",
	Annotations: "notifications.annotations",
	UserID:      "notifications.user_id",
	CreatedAt:   "notifications.created_at",
	SeenAt:      "notifications.seen_at",
}
...
var NotificationWhere = struct {
	...
	Annotations: whereHelpertypes_JSON{field: "\"notifications\".\"annotations\""},
	UserID:      whereHelperstring{field: "\"notifications\".\"user_id\""},
	CreatedAt:   whereHelpertime_Time{field: "\"notifications\".\"created_at\""},
	SeenAt:      whereHelpernull_Time{field: "\"notifications\".\"seen_at\""},
}
...
var (
	notificationAllColumns            = []string{"id", "annotations", "user_id", "created_at", "seen_at"}
	notificationColumnsWithoutDefault = []string{"user_id", "seen_at"}
	notificationColumnsWithDefault    = []string{"id", "annotations", "created_at"}
